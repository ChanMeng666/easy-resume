 ...
 * @param tokens - Design tokens; only `density` is honored (this template uses a
 *   fixed understated palette), defaults to comfortable
 */
export function generateAcademicCV(data: ResumeData, tokens: DesignTokens = DEFAULT_TOKENS): string {
  const sections = [
