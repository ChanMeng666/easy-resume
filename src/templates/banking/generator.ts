 ...
 * @param tokens - Design tokens; only `density` is honored (this template is
 *   deliberately colorless), defaults to comfortable
 */
export function generateBankingResume(data: ResumeData, tokens: DesignTokens = DEFAULT_TOKENS): string {
  const sections = [
